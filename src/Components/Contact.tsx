      ...
      <div className="w-[350px] lg:w-full flex items-center content-center h-[500px]  p-10 mx-auto">
        ...
        ></div>
           ...
           <div className="flex items-center gap-2">
            ...
            <button className="bg-[#1877F2] rounded-tl-4 rounded-tr-full rounded-br-full rounded-l-4 p-3 hover:bg-gradient-to-br from-[#6d4cff] via-[#6d4cff] to-[#1177F2]">  <img src="/btn.png" alt="" /></button>
            </div>
           </div>
        </div>
            </div>
